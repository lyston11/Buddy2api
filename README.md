...
> ### ⚠️ 免责声明
>
> 本项目是**个人学习与技术研究项目**，仅供**本机自用与学习交流**。作者**不鼓励、不授权任何商业使用**—— 包括但不限于对外提供付费服务、二次销售、打包进商业产品、用于生产环境。
>
> - 与 WorkBuddy / CodeBuddy、QClaw、千问办公、TraeWork 等任何厂商**均无关联**，也未获得其授权或认可；请自行确认并遵守各厂商的用户协议与服务条款。
> - 使用本工具可能导致的**账号风控、封禁、额度损失**及任何其他后果，**由使用者自行承担**。
> - 请勿公开部署，也不要分享登录凭据、API Key 或数据库文件。
>
> 继续使用即表示已理解并接受以上内容。代码许可证以 [LICENSE](LICENSE) 为准。
